...
Version  : 0.4.21
Release  : 1
URL      : https://cran.r-project.org/src/contrib/proxy_0.4-21.tar.gz
Source0  : https://cran.r-project.org/src/contrib/proxy_0.4-21.tar.gz
Summary  : Distance and Similarity Measures
Group    : Development/Tools
License  : GPL-2.0
Requires: R-proxy-lib
...
export LANG=C
export SOURCE_DATE_EPOCH=1521195196
